...
import { getProducts, removeProduct, toggleDeleteSuccess, updateProduct } from "../../features/products/productsSlice";
...
const ProductList = () => {
  ...
  const {products, isLoading, isError, deleteSuccess, error} = useSelector((state) => state.products );
                  ...
                  <td class='p-2'>
                    <div class='flex justify-center'>
                      ...
                      <button 
                         ...
                         onClick={() => { dispatch(updateProduct(product)); {navigate("/dashboard/update-product")} }}
                          >
                         < FiEdit size={20} />
                      </button>
